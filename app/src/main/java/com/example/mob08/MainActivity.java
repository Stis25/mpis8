...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeButtonAuthor() {
        buttonAuthor = findViewById(R.id.authorBtn);
        buttonAuthor.setOnClickListener(view -> showAlertDialog("Разработал", getString(R.string.author)));
    }
